...
public interface TeamDataService {
	...
	public TeamVO findTeamInfo(int teamId);// 返回确切的某一个球队的基本信息

	public ArrayList<TeamVO> findTeamNormal();    // 返回球队基本信息列表，按id升序排列;true表示场均
	public ArrayList<TeamVO> findTeamNormalAvg(); // 返回球队基本信息列表，按id升序排列;true表示场均
	public ArrayList<TeamVO> findTeamBasic();     // 返回球队基本信息列表，按id升序排列;true表示场均
