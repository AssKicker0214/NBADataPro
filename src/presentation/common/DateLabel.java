...
public class DateLabel extends JLabel{
    ...
    private JP3 jp3;
    private JP4 jp4;
    private Font font=new Font("幼圆",Font.PLAIN,12);
    ...
    public DateLabel(Date date){
        ...
        initPanel();
        //initLabel();
        this.setText(sdf.format(initDate));
        ...
        this.addMouseListener(new MouseAdapter(){
            public void mouseEntered(MouseEvent me){
                if(self.isEnabled()){
                	self.setCursor(new Cursor(Cursor.HAND_CURSOR));
    ...
    public void setEnabled(boolean b){
        super.setEnabled(b);
        self.setEnabled(b);//showDate.setEnabled(b);
    }
    /**
     *得到当前选择框的日期
     */
    ...
    private void commit(){
        ...
        self.setText(sdf.format(select.getTime()));
        hidePanel();
    }
    ...
    private void showPanel(Component owner){
        ...
        Point show=new Point(0,self.getHeight());
        SwingUtilities.convertPointToScreen(show,self);
    ...
    private class JP1 extends JPanel{
        ...
        public JP1(){
            ...
            this.setBackground(new Color(160,185,215));//new Color(160,185,215)
            initJP1();
        }
        private void initJP1(){
            left=new JLabel(" << ",JLabel.CENTER);
            left.setToolTipText("last month");
            right=new JLabel(" >> ",JLabel.CENTER);
            right.setToolTipText("next month");
    ...
    private class JP2 extends JPanel{
        ...
        protected void paintComponent(Graphics g){
            g.setFont(font);
            g.drawString("SUN    MON    TUE    WED    THURS    FIR    SAT",10,10);
