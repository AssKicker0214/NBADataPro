...
//			PlayerKingPanel.this.remove(everyDay_PlayerKingOptionsPanel);
	...
	public void setBasicInfoTablePanel(){
		...
		BasicInfoTable = new playerTablePanel(datas,header,wid,0,60,1280,350,50,true,false);
	...
	public void setNormalInfoTablePanel(boolean isAvg){
		...
		NormalInfoTable = new playerTablePanel(datas,tbHead,wid,0,60,1280,320,50,true,true);
