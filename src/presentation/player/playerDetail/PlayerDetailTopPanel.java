...
//		g2.drawString("Line", 350, 250);
	...
	public void setPlayerPhotoLabel (){
		JLabel playerPhotoLabel = new PhotoLabel(new ImageIcon("1.png").getImage());
	...
	public void setTeamPicLabel(){
		JLabel teamPicLabel = new PhotoLabel(new ImageIcon("teamsPNG/ATL.png").getImage());
	...
	public void setPlayerName(){
		playerNameLabel = new JLabel("Jordan-Adams");
	...
	public void setPlayerPos_Team(){
		playerPos_TeamLabel = new JLabel("POS／TEAM NAME");
	...
	public void setPlayerBasicInfoPanel(){
		...
		JLabel height_weightLabel = new JLabel("Height/Weight:     "+"6-0/161");
		...
		JLabel birthdatLabel = new JLabel("Bitrh:     " + "JAN 14,1985");
